      ...
      <div className="ml-[350px] mt-16">
        ...
        <div className="mt-10">
          ...
          <div className="flex mb-4">
            ...
            />
            <h2 className="text-[14px] text-gray-500">{feeDetails.message}</h2>
          </div>

          <hr className="decoration-dashed mr-[380px]"></hr>

          <div className="flex text-[14px] mt-4 text-gray-800 font-bold">
            <svg
              width="18"
              height="18"
              viewBox="0 0 18 18"
            ...
            <h2 className="px-2 mt-[-1px]">{sla.slaString}</h2>
            <svg
              class="mx-4"
              width="18"
              height="18"
            ...
            <h1 className="mx-[-8px] mt-[-1px]">{costForTwoMessage}</h1>
          </div>
        </div>
      </div>
    </>
